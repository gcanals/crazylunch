...
--
-- Client: localhost
-- Généré le: Mar 11 Février 2014 à 09:16
...
(1, 'Chez Mario et Luigi', 'Les pizzaiolos du jeu video !!', '8 rue sous le tuyau.\r\nMarioLand', 'mario@marioland', 4, 'pizza.resto.1.jpg'),
(2, 'Fu Mange Tout', 'Le meilleur restaurant chinois de toute la ville.', 'Shangai', 'Fu@MangTout', 1, 'chinois.resto.1.jpg'),
(3, 'Les sushis sont secs', 'Une tradition directement venue du Japon. Tous les sushis de vos souhaits !', '32 Rue de Totoro\r\nNancy', 'Sushi@sonsecs', 3, 'sushi.resto.2.jpg'),
(4, 'SMSexicain', 'Le meilleur restaurant de TextMex. Tapas et Fajitas à volonté (et plus encore).\r\n\r\nPour ceux qui n''ont pas froid aux yeux', '14 rue de la grand place\r\nLaxouVille\r\n', 'sms@xicain', 2, 'mex.resto.1.jpg'),
(7, 'Pizza the Hut', 'La seule pizzeria qui possède l''achtusse.', '2 impasse de la galaxie\r\nLuxembourgVille', 'pizza@thehut', 4, 'pizza.resto.2.jpg'),
(8, 'Yamazaki', 'De nombreux sushis fait avec amour et avec le poisson le plus frais du marché.', '5 Grand Rue\r\nMalzéville', 'yama@saki', 3, 'sushi.resto.3.jpg'),
(9, 'Little Pakistan', 'Délices du Pakistan', '12 rue du Faubour des Trois Maison, 54000, nancy', 'little@pakistan', 5, 'indien.resto.1.jpg'),
(10, 'Le Taj Mahal', 'On aime les épices', '45 rue des Fabrique, 54000 Nancy', 'taj@mahal', 5, 'indien.resto.2.jpg');
